...
# Time and date tools
@tool(name="current_time", description="Get current date and time", timeout=2.0)
...
# File system tools
@tool(name="file_reader", description="Read content from a file", timeout=10.0)
...
@tool(name="file_writer", description="Write content to a file", timeout=10.0)
...
@tool(name="list_sorter", description="Sort a list of items", timeout=5.0)
...
# Utility tools
@tool(name="sleep", description="Sleep for specified number of seconds", timeout=30.0)
